...
class ChainingDictionaryTests: XCTestCase {
    ...
    func testExample() {
        ...
        var dict3 = ChainingDictionary<Int, String>()
        dict3.set("one", for: 1)
        dict3.set("two", for: 2)
        ...
        var dict4 = ChainingDictionary<SomeStupidKey, String>()
